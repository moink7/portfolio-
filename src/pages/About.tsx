...
const About: React.FC = () => {
  return (
    <div
      ...
      className="w-full h-screen bg-gradient-to-b from-gray-800 to-black text-white overflow-x-hidden"
    >
      <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full overflow-x-hidden">
        <div className="pb-8">
